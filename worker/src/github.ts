...
export class GithubCrawler {
   ...
   */
  public async fetchDeveloperProfile(username: string, logCallback: (msg: string, progress: number) => void): Promise<GithubProfile> {
   ...
   */
  private generateSimulatedProfile(username: string, logCallback: (msg: string, progress: number) => void): GithubProfile {
